...
public class ClassSavingTest {
    ...
    /**
     * Test of enrollStudentUpdating if not exist method, of class ClassSaving.
     */
    @Test
    public void testEnrollStudentUpdatingIfNotExist() {
        ...
        instance.enrollStudentUpdating(student);
    ...
    public void testEnrollStudentUpdatingIfNotExistInsertingTwo() {
        ...
        ClassSaving instance = new ClassSaving();
        instance.enrollStudentUpdating(student);
        instance.enrollStudentUpdating(student2);
    ...
    /**
     * Test of enrollStudentUpdating method if exist, of class ClassSaving.
     */
    @Test
